# Since the real root_pandas is deprecated, I created a fake root_pandas module
# using uproot3 that has the same syntax as root_pandas (because I like the concise
# syntax of root_pandas better than that of uproot3).  
