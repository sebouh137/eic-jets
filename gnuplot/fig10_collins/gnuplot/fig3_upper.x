...
set output 'electron_beam_with_stats.tex'
...
set label 'Electron beam' at 0.05,0.14
set label '$0.10<x<0.20$' at 0.05,0.09
#set label '\scriptsize CC DIS 10+275 GeV, 100 fb$^{-1}$, $0.01<y<0.9,\ Q^2>100$ GeV$^2$' at 0.35,0.54
...
plot '< paste lower1.dat upper1.dat' using 1:2:5 with filledcurves fs solid 0.4 lt rgb "orange" title '' ,\
     ...
     '../fig3_pip_e-_p1.dat' u 1:2 w lines smooth sbezier lw 4 lc rgb "orange" title '$\pi^+$' ,\
     '../stats/211_e-_p0.dat' with errorbars t  '' pt 6 ps 1.5 lw 2.5 lt rgb "black" ,\
     '../fig3_pim_e-_p1.dat' u 1:2 w lines smooth sbezier lw 4 lc rgb "blue" title '$\pi^-$' ,\
     '../stats/-211_e-_p0.dat' u ($1+.01):2:3 with errorbars t  '' pt 7 ps 1.5 lw 2.5 lt rgb "black" ,\
     'y0.dat' u 1:2 w lines lc rgb "black" lt '-' lw 2 title '' ,\
...
set label '$0.20<x<0.30$' at 0.05,0.09

plot '< paste lower3.dat upper3.dat' using 1:2:5 with filledcurves fs solid 0.4 lt rgb "orange" title '' ,\
     '< paste lower4.dat upper4.dat' using 1:2:5 with filledcurves fs solid 0.4 lt rgb "blue" title '' ,\
     '../fig3_pip_e-_p2.dat' u 1:2 w lines smooth sbezier lw 4 lc rgb "orange" title '$\pi^+$' ,\
     '../stats/211_e-_p1.dat' with errorbars t  '' pt 6 ps 1.5 lw 2.5 lt rgb "black" ,\
     '../fig3_pim_e-_p2.dat' u 1:2 w lines smooth sbezier lw 4 lc rgb "blue" title '$\pi^-$' ,\
     '../stats/-211_e-_p1.dat' u ($1+.01):2:3 with errorbars t  '' pt 7 ps 1.5 lw 2.5 lt rgb "black" ,\
     'y0.dat' u 1:2 w lines lc rgb "black" lt '-' lw 2 title '' ,\
...
set label '$0.30<x<0.50$' at 0.05,0.09

plot '< paste lower5.dat upper5.dat' using 1:2:5 with filledcurves fs solid 0.4 lt rgb "orange" title '' ,\
     '< paste lower6.dat upper6.dat' using 1:2:5 with filledcurves fs solid 0.4 lt rgb "blue" title '' ,\
     '../fig3_pip_e-_p3.dat' u 1:2 w lines smooth sbezier lw 4 lc rgb "orange" title '$\pi^+$' ,\
     '../stats/211_e-_p2.dat' with errorbars t  '' pt 6 ps 1.5 lw 2.5 lt rgb "black" ,\
     '../fig3_pim_e-_p3.dat' u 1:2 w lines smooth sbezier lw 4 lc rgb "blue" title '$\pi^-$' ,\
     '../stats/-211_e-_p2.dat' u ($1+.01):2:3 with errorbars t  '' pt 7 ps 1.5 lw 2.5 lt rgb "black" ,\
     'y0.dat' u 1:2 w lines lc rgb "black" lt '-' lw 2 title '' ,\
...
system('latex electron_beam_with_stats.tex && dvips electron_beam_with_stats.dvi && ps2eps -f electron_beam_with_stats.ps && epstopdf electron_beam_with_stats.eps && rm electron_beam_with_stats-inc.eps electron_beam_with_stats.ps *.aux *.dvi *.log *.tex')
